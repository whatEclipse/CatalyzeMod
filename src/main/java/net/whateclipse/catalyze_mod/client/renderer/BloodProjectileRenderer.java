...
public class BloodProjectileRenderer extends EntityRenderer<BloodProjectileEntity> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Catalyze_mod.MODID,
    ...
    @Override
    public void render(@Nonnull BloodProjectileEntity entity, float entityYaw, float partialTicks,
