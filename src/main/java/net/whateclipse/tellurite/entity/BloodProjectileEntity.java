package net.whateclipse.tellurite.entity;
    ...
    public void tick() {
        ...
        if (this.level().isClientSide && !this.inGround) {
            ...
            if (this.random.nextFloat() < 0.7F) { // Spawn rate
                ...
                // Spawn the particle
                this.level().addParticle(net.whateclipse.tellurite.particles.ModParticleTypes.BLOOD_BUBBLE_PARTICLE.get(), px, py, pz, 0.0D, 0.0D, 0.0D);
            }
        }
    }
